...
namespace GAudio.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(GAudioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Company != null ? 
                          ...
                          Problem("Entity set 'GAudioContext.Company'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GAudioContext.Company'  is null.");
            }
            var company = await _context.Company.FindAsync(id);
            if (company != null)
            {
